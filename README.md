...
│  │                     │  │                      │  │  level_ │ │
│  │  Store: MI summary  │  │  Store: short+medium │  │  reflec │ │
│  │  Meta: symbol, date,│  │  +long reasoning     │  │  tion   │ │
│  │  short/medium/long  │  │  combined text       │  │         │ │
│  │  term_query         │  │  Meta: symbol, date  │  │  Store: │ │
│  └─────────────────────┘  └──────────────────────┘  │  summary│ │
│           ↑ ↓                      ↑ ↓               └─────────┘ │
│           MI                      LLR                    ↑ ↓     │
│    (Diversified Retrieval)   (search via short_term_query) HLR   │
└──────────────────────────────────────────────────────────────────┘
```
